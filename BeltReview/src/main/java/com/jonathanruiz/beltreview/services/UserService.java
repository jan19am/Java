...
import com.jonathanruiz.beltreview.repositories.UserRepository;
...
public class UserService {
	...
	public User addToProjects(Long projectId, Long userId) {
		Project p = pRepo.findById(projectId).orElse(null);
...
//		userRepo.save(u);
	...
	public List<User> uncollected(Project p) {
		return userRepo.findByProjectsNotContains(p);
	}
}
